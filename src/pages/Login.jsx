...
const Login = () => {
    ...
    return (
        <>
            <div className="bg-[#F4F5F8] md:w-3/4 lg:w-1/2 mx-auto md:mb-10 lg:mb-20">
                <div className="text-center pt-20">
                    <h2 className="text-4xl text-black font-bold bg-accent p-10">Please Sign In</h2>
                </div>
                <div className="">
                    ...
                    <div className="text-center pb-10">
                        <p className="md:text-2xl">Do not have an account? Please <Link to='/register' className="text-purple-500">Register</Link></p>
                    </div>
                </div>
            </div>
        </>
